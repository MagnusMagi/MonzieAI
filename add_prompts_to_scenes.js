...
const SERVICE_ROLE_KEY = process.env.SUPABASE_SERVICE_ROLE_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imdyb2d1YXRiamVyZWJ3ZWludWVmIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2NTEwMDY2NSwiZXhwIjoyMDgwNjc2NjY1fQ.AzReOmy0sjsagWar6zv1EKRW3Z41E6Gpd_X_uxz8Y6s';
...
const scenes = [
  {
    ...
    description: 'Dramatic, ultra-realistic close-up in black and white with high-contrast cinematic lighting',
    category: 'portrait',
    prompt_template: 'Dramatic, ultra-realistic close-up in black and white with high-contrast cinematic lighting from the side, highlighting the contours of his face and beard, casting deep shadows. He wears round, reflective sunglasses. He gazes confidently upward into a dark void. The sunglasses reflect a city\'s towering skyline. The atmosphere is mysterious with a minimalist black background. Details in 4K. Keep the subject\'s exact facial structure, hair texture, the original photo.',
    preview_url: 'https://cdn.bananaprompts.xyz/18973a18-e495-4d7c-b8aa-a7fc55767459/cb66879a-fcef-4010-ad28-5033521e664b.png?w=3840&q=75',
    is_active: true
  },
  {
  ...
  },
  {
    ...
    preview_url: 'https://cdn.bananaprompts.xyz/2513bb4b-b97f-4488-9f3e-7cc8448f1568/c30a900e-8ba4-4a2d-ac99-d18eb216898d.png?w=3840&q=75',
    is_active: true
  },
  {
    name: 'Gini',
  ...
  },
  {
    ...
    category: 'portrait',
    prompt_template: 'Uma foto realista com todos os traços e linhas idênticos ao da foto com um semblante imponente, em preto em branco, no traje de terno preto e gravata slim.',
    preview_url: 'https://cdn.bananaprompts.xyz/e7cafee4-0124-4156-90e2-faad0e1e8b60/aad96207-11a9-4943-a8a5-6ede4d234f9f.jpeg?w=3840&q=75',
    is_active: true
  },
  {
  ...
  },
  {
    ...
    category: 'portrait',
    prompt_template: 'Studio photography of a me in a black suit, black turtleneck and round sunglasses with translucent yellow lenses. Vibrant orange background. Unique poses from the front.',
    preview_url: 'https://cdn.bananaprompts.xyz/68155dad-d783-427e-bb9e-b7254480bf27/6080b41d-5c16-40b8-b8f4-baf2d3722a75.jpeg?w=3840&q=75',
    is_active: true
  },
  {
